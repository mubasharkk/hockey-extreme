<?php $__env->startSection('page-content'); ?>
    ...
    <!-- Header -->
    <header id="top" class="header" style="background-image: url(<?php echo e(url('img/front/'.rand(1,10).'.jpg')); ?>)">
        <div class="text-vertical-center">
            <h1 class="text-warning" >
                <span style="background-color:rgba(0,0,0,0.4); color:#FFF;"><?php echo e(config('app.name')); ?></span>
            </h1>
