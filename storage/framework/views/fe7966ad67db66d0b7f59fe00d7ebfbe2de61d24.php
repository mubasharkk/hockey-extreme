<div class="form-group <?php echo !$errors->has($errorKey) ?: 'has-error'; ?>">
    ...
    <div class="col-sm-6">
        ...
        <div class="input-group">
            ...
            <input type="password" id="<?php echo e($id); ?>" name="<?php echo e($name); ?>" value="<?php echo e(old($column, $value)); ?>" class="form-control" placeholder="<?php echo e($placeholder); ?>" <?php echo $attributes; ?> />
        </div>
